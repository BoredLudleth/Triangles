...
TEST(TestTriangle, TrgTest) {
  ...
  triangle<float> trg20(408.6, -666.9, -721.3, 374.6, -660, -746.4, 372.3,
                        -720.7, -782.5);
  triangle<float> trg21(323, -647.3, -784.8, 467.5, -650.5, -726.3, 366.6,
                        -766.3, -783.1);
  EXPECT_EQ(trg20.intersection(trg21), 1);

  triangle<float> trg22(-705.3, 879.3, 547.2, -715.7, 874.9, 559.9, -712.1,
                        880.1, 558.2);
  triangle<float> trg23(-702.7, 876.5, 551.7, -702.1, 889.6, 540.6, -713.6,
                        879.3, 543.8);
  EXPECT_EQ(trg22.intersection(trg23), 1);

  triangle<float> trg24(126.149, 138.178, 171.904, 126.172, 137.917, 170.911,
                        125.882, 138.295, 171.045);
  triangle<float> trg25(126.594, 138.351, 171.605, 125.963, 137.83, 171.136,
